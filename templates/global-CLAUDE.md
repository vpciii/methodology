...
| Independently check a substantial change / hard design decision | an adversary-model review — a *different* model refutes it; advisory, human adjudicates; record in `docs/reviews/` (ADR 0023) |
