#!/usr/bin/env python3
"""Spec-criterion coverage checker — reference implementation.

Verifies the traceability rules of methodology §5 (ADR 0006, 0011)
for every spec whose status makes coverage mandatory:
